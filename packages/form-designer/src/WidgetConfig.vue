...
<template>
  <div v-if="show">
    <el-form label-position="top" class="form" size="mini">
      ...
      <el-form-item v-if="data.type != 'button' && data.type != 'upload' && data.type != 'text'&& data.type != 'grid' "
                  :label="data.type === 'blank'? '插槽名(需结合代码)': '字段标识'">
      <el-input size="mini" v-model="data.model"></el-input>
    </el-form-item>
      ...
      <el-form-item label="显示文本"
        ...
        <el-input size="mini" v-model="data.options.text"></el-input>
      </el-form-item>
      <el-form-item label="回调方法"
                    v-if="Object.keys(data.options).indexOf('btnCommand')>=0">
        <el-input size="mini" v-model="data.options.btnCommand"></el-input>
      </el-form-item>
      <el-form-item label="标签宽度" v-if="data.labelWidth">
         <el-input-number size="mini" v-model="data.labelWidth"
                         :min="100"
                         :max="180"
                         :step="10"
                         style="width: 100%"
      ...
      <el-form-item label="隐藏标签" v-if="data.options.hiddenLabel">
      ...
      <el-form-item label="占位内容"
        ...
        <el-input size="mini" v-model="data.options.placeholder"></el-input>
      </el-form-item>
      ...
      <el-form-item label="最小值"
        ...
        <el-input-number size="mini" v-model="data.options.min"
                         :min="0"
                         :max="100"
      ...
      <el-form-item label="最大值"
        ...
        <el-input-number size="mini" v-model="data.options.max"
                         :min="0"
                         :max="100"
                         :step="1"></el-input-number>
      </el-form-item>
      <el-form-item label="步长"
        ...
        <el-input-number size="mini" v-model="data.options.step"
                         :min="0"
                         :max="100"
                         :step="1"></el-input-number>
      </el-form-item>
      ...
      <el-form-item label="数据来源"
        ...
        <template v-if="data.options.remote=='dict'">
          <el-select size="mini" v-model="data.options.dictType"
                     placeholder="字典类型"
                     filterable
                     style="width: 100%">
              ...
              <Draggable tag="ul"
                ...
                <li v-for="(item, index) in data.options.options"
                  ...
                  <el-radio :label="item.value"
                    ...
                    <el-input size="mini" :style="{'width': data.options.showLabel? '90px': '190px' }"
      ...
      <el-form-item label="对齐方式" v-if="data.type === 'text'">
          <el-select size="mini" style="width:100%" v-model="data.options.align">
       ...
       <el-form-item label="字体大小" v-if="data.type === 'text'">
          <el-input size="mini" placeholder="例如(16px)" v-model="data.options.fontSize"></el-input>
      </el-form-item>
      <el-form-item label="默认值"
        ...
        <el-input size="mini" v-if="data.type=='textarea'"
                  type="textarea"
                  :rows="5"
                  v-model="data.options.defaultValue"></el-input>
        <el-input size="mini" v-if="data.type=='input' || data.type == 'select'"
                  v-model="data.options.defaultValue"></el-input>
        <el-input size="mini" placeholder="此处输入html" type="textarea" v-if="data.type=='html'" v-model="data.options.defaultValue"></el-input>
      ...
      <template v-if="data.type == 'time' || data.type == 'date'">
        <el-form-item label="显示类型"
                      v-if="data.type == 'date'">
          <el-select size="mini" v-model="data.options.type">
        ...
        <el-form-item label="选择范围"
                      v-if="data.type == 'date'">
          <el-select size="mini" v-model="data.options.range"
                     clearable
        ...
        <el-form-item label="开始时间占位内容"
                      ...
                      || data.options.type=='daterange'">
          <el-input size="mini" v-model="data.options.startPlaceholder"></el-input>
        </el-form-item>
        <el-form-item label="结束时间占位内容"
                      v-if="data.options.isRange || data.options.type=='datetimerange'
                      || data.options.type=='daterange'">
          <el-input size="mini" v-model="data.options.endPlaceholder"></el-input>
        </el-form-item>
        <el-form-item label="格式">
          <el-input size="mini" v-model="data.options.format"></el-input>
        </el-form-item>
        <el-form-item label="默认值"
      ...
      <!-- <template v-if="data.type=='blank'">
        <el-form-item label="绑定数据类型">
          <el-select size="mini" v-model="data.options.defaultType">
      ...
      <template v-if="data.type !== 'grid'">
        <el-form-item v-if="data.type === 'upload'"
                      label="关联字段名">
          <el-input size="mini" v-model="data.options.resourceId"></el-input>
        </el-form-item>
        <el-form-item v-if="data.type === 'upload'"
                      label="附件类型">
          <el-input size="mini" v-model="data.options.fileType"
        ...
        <template v-if="data.type=='table'">
          <el-form-item label="后台表名">
            <el-input size="mini" v-model="data.options.tableName"
                      placeholder="tableName"></el-input>
          </el-form-item>
          <el-form-item label="表格设计名">
            <el-input size="mini" v-model="data.options.tableDesignerName"
                      placeholder="tableDesignerName"></el-input>
          </el-form-item>
          <el-form-item label="表单设计名">
            <el-input size="mini" v-model="data.options.dialogFormDesignerName"
                      placeholder="dialogFormDesignerName"></el-input>
          </el-form-item>
          <el-form-item label="表格标题">
            <el-input size="mini" v-model="data.options.tableTitle"
                      placeholder="表格标题"></el-input>
          </el-form-item>
          <el-form-item label="预设值">
            <el-input size="mini" v-model="data.options.prefill"
                      placeholder="例如:子表字段1,主表字段1|子表字段2,主表字段2"></el-input>
          </el-form-item>
          <el-form-item label="预设查询参数">
            <el-input size="mini" v-model="data.options.tableParams"
                      placeholder="例如:子表字段1,主表字段1|子表字段2,主表字段2"></el-input>
          </el-form-item>
        ...
        <template v-if="data.type === 'treeselect'">
          <el-form-item label="最大高度">
            <el-input size="mini" v-model="data.options.maxHeight"
...
export default {
  ...
  watch: {
    ...
    'data.options.dataType': function watchDataType(val) {
      ...
      // 如果自定义了错误提示语则赋值
      if (this.data.options && this.data.options.message !== null && this.data.options.message !== '') {
