...
<template>
  <el-container>
    ...
    <!-- 自动设置 -->
    <el-dropdown @command="autoSet" v-if="formList.length > 0">
      <el-button size="small">快捷设置<i class="el-icon-arrow-down el-icon--right"></i> </el-button>
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item command="generateTableByForm"> [请先设置表单]根据表单生成表格 </el-dropdown-item>
        <el-dropdown-item command="autoSetSearchOption"> [请先设置表单]分析表单配置以设置表格高级搜索options </el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
